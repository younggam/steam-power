...
const heatBridge=heatL.heatBridge(ItemBridge,ItemBridge.ItemBridgeEntity,"heat-bridge",{
  heatCapacity:500,
  setBars(){
    this.super$setBars();
...
heatBridge.hasLiquids=false;
heatBridge.hasItems=false;
heatBridge.hasPower=false;
heatBridge.canOverdrive=false;
