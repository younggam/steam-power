...
const totalBurner=heatL.heatGiver(Block,TileEntity,"total-burner",{
  ...
  displayConsumption(tile,table){
    ...
    this.consumeItems.forEach(i=>image.add(new ReqImage(new ItemImage(i.icon(Cicon.medium),1),boolp(()=>typeof entity["items"]==="object"&&entity.items!=null&&entity.items.has(i)))));
